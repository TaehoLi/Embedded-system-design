...
//!	Generated Date	: Wed, 15, May 2019  
	File Path	: CanButtonTest/MontaVista/Elevator.h
*********************************************************************/
...
class Elevator_C : public OMReactive {
    ////    Constructors and destructors    ////
    
public :

    //## auto_generated
    Elevator_C(IOxfActive* theActiveContext = 0);
...
inline bool Elevator_C::rootState_IN() const {
    return true;
}

inline bool Elevator_C::up_IN() const {
    return rootState_subState == up;
}

inline bool Elevator_C::stop_IN() const {
    return up_subState == stop;
}

inline bool Elevator_C::open_IN() const {
    return up_subState == open;
}

inline bool Elevator_C::moving_IN() const {
    return up_subState == moving;
}

inline bool Elevator_C::close_IN() const {
    return up_subState == close;
}

inline bool Elevator_C::check_IN() const {
    return up_subState == check;
}

inline bool Elevator_C::init_IN() const {
    return rootState_subState == init;
}

inline bool Elevator_C::first_floor_check_IN() const {
    return rootState_subState == first_floor_check;
}

inline bool Elevator_C::down_IN() const {
    return rootState_subState == down;
}

inline bool Elevator_C::down_stop_IN() const {
    return down_subState == down_stop;
}

inline bool Elevator_C::down_open_IN() const {
    return down_subState == down_open;
}

inline bool Elevator_C::down_moving_IN() const {
    return down_subState == down_moving;
}

inline bool Elevator_C::down_close_IN() const {
    return down_subState == down_close;
}

inline bool Elevator_C::down_check_IN() const {
