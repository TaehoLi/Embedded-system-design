...
CanButton.o : CanButton.cpp CanButton.h    Elevator.h 
...
Elevator.o : Elevator.cpp Elevator.h    CanButton.h 
	@echo Compiling Elevator.cpp
	$(CREATE_OBJ_DIR)
	@$(CC) $(ConfigurationCPPCompileSwitches)  -o Elevator.o Elevator.cpp
